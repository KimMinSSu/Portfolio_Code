...
//my
void iGraphics::fillRect2(iRect rt, float radius)
{
	fillRect2(rt.origin.x, rt.origin.y, rt.size.width, rt.size.height, radius);
}

void iGraphics::fillRect2(float x, float y, float width, float height, float radius)
{
	float r, g, b, a;
	getRGBA(r, g, b, a);
	SolidBrush brush(Color(floatToUint8(a),
...
void iGraphics::drawTri(float x, float y, float width, float height)
{
	float r, g, b, a;
	getRGBA(r, g, b, a);
	float lineWidth = getLineWidth();
...
void iGraphics::fillTri(float x, float y, float width, float height)
{
	float r, g, b, a;
	getRGBA(r, g, b, a);
	SolidBrush brush(Color(floatToUint8(a),
