...
//kim
int iString::isUnicode(const char* str)
{
	int b = 0;
	if ((str[0] & 128) == 0) b = 1;			// ?XXX XXXX
	else if ((str[0] & 224) == 192) b = 2;	// 110X XXXX 128 + 64
	else if ((str[0] & 240) == 224) b = 3;	// 1110 XXXX 128 + 64 + 32
	return b;
