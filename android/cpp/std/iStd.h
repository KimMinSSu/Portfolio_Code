...
//typedef void(*MethodDrawLine)(iPoint sp, iPoint ep);
//typedef void(*MethodDrawLine1)(float x0, float y0, float x1, float y1);
//extern MethodDrawLine drawLine;
...
void setFilterStr(const char* strFrag);
